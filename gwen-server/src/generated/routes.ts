...
export function RegisterRoutes(app: Router) {
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsUserFactionDeckController_getUserFactionDeck: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    userId: { in: 'path', name: 'userId', required: true, dataType: 'string' },
  ...
  app.get(
    ...
    async function UserFactionDeckController_getUserFactionDeck(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserFactionDeckController_getUserFactionDeck,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsUserFactionDeckController_createUserFactionDeck: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    userId: { in: 'path', name: 'userId', required: true, dataType: 'string' },
  ...
  app.post(
    ...
    async function UserFactionDeckController_createUserFactionDeck(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserFactionDeckController_createUserFactionDeck,
          request,
          response,
        });
